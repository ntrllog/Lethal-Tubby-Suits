 ...
 *  copied from https://github.com/AlexCodesGames/LC-Additional-Suits
 */
namespace TubbySuits
{
    ...
    public class AdditionalSuitsBase : BaseUnityPlugin
    {
        ...
        //mod details
        private const string modGUID = "ntrllog.TubbySuits";
        private const string modName = "TubbySuits";
        ...
        void Awake()
        {
            ...
            //set folder location
            ModResourceFolder = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "great_great_assets");
